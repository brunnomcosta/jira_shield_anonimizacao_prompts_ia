...
const TECHNICAL_CONTEXT_VERSION = 2;
...
function extractIssueTechnicalContext(issue, zendeskData = null) {
...
function flattenTechnicalReferences(technicalContext, groups = GROUP_ORDER) {
...
function correlateTechnicalContextWithFiles(technicalContext, files) {
...
function buildTechnicalContextTextSection(technicalContext, options = {}) {
  const references = flattenTechnicalReferences(technicalContext);
...
function buildTechnicalContextPromptSection(technicalContext, correlation = null) {
